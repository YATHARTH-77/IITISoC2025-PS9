...
print("Running updated german.py - Version 2025-07-31")  # Version marker
...
model_path = "../FineTune/German/best_german_ocr_model.pth"    # Path to your fine-tuned weights
character_list_path = "../FineTune/German/training_data/character_list.txt"  # Path to character list used during training
weights_path = "../FineTune/German/best_german_ocr_model.pth"
...
# Define the fine-tuned model (same architecture as French)
...
def run_ocr_all(image_np, box_id):
    ...
    text = pytesseract.image_to_string(resized, lang='deu+eng', config='--psm 6')
    if text.strip():
...
def detect_language(text):
    try:
        ...
        return 'de'  # Fallback to German for this script

# Function to generate speech (optional - keeping from original)
