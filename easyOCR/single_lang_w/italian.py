...
print("Running final updated italian.py - Version 2025-07-31 06:15 PM IST")  # Unique version marker
...
def run_ocr_all(image_np, box_id):
    ...
    text = pytesseract.image_to_string(resized, lang='ita+eng', config='--psm 6')
    if text.strip():
