...
print("Running final updated french.py - Version 2025-08-02 01:22 AM IST")  # Updated version marker
...
# Function to run OCR with both fine-tuned model and EasyOCR simultaneously, with Tesseract fallback
