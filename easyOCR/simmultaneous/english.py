...
print("Running final updated english.py - Version 2025-08-02 01:41 AM IST")  # Updated version marker
...
def run_ocr_all(image_np, box_id):
    ...
    if conf_custom > threshold_custom:
        ...
        text_tesseract = pytesseract.image_to_string(resized, lang='eng', config='--psm 6')
