...
print("Running updated turkish_simultaneous.py - Version 2025-08-02 02:45 AM IST")  # Version marker
...
model_path = "../../Weights/Turkish/best_turkish_ocr_model.pth"  # Path to fine-tuned weights
...
def run_ocr_all(image_np, box_id):
    ...
    if conf_custom > threshold_custom:
        ...
        text_tesseract = pytesseract.image_to_string(resized, lang='tur+eng', config='--psm 6')
