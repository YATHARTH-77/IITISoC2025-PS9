...
print("Running updated spanish_simultaneous.py - Version 2025-08-02 02:30 AM IST")  # Version marker
...
model_path = "../../Weights/spanish/best_spanish_ocr_model.pth"    # Path to fine-tuned weights
character_list_path = "../../Weights/spanish/training_data/character_list.txt"  # Path to character list
...
print("EasyOCR reader initialized for languages: es, en")
...
def run_ocr_all(image_np, box_id):
    ...
    if conf_custom > threshold_custom:
        ...
        text_tesseract = pytesseract.image_to_string(resized, lang='spa+eng', config='--psm 6')
