...
print("Running updated russian_simultaneous.py - Version 2025-08-02 02:15 AM IST")  # Version marker
...
model_path = "../../Weights/Russian/best_russian_ocr_model.pth"  # Path to fine-tuned weights
character_list_path = "../../Weights/Russian/training_data/character_list.txt"  # Path to character list
weights_path = "../../Weights/Russian/best_russian_ocr_model.pth"
...
def run_ocr_all(image_np, box_id):
    ...
    if conf_custom > threshold_custom:
        ...
        text_tesseract = pytesseract.image_to_string(resized, lang='rus+eng', config='--psm 6')
